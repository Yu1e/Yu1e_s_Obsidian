...
Cобирает алфавитный список ==подсвеченных== ==фрагментов== из всех заметок хранилища.
Вставляется в обычную заметку и работает из неё.
Необходим плагин плагин [Horizontal Blocks](https://github.com/iCodeAlchemy/horizontal-blocks).
...
Как пользоваться: создайте новую заметку, разместите в ней блок кода dataviewjs. Закрепите заметку в левой или правой панели, перетащив из Проводника Обсидиана. Не перетаскивайте из основного окна - иначе закрепится широкая вкладка, а не значок.

# [random_note_2.0](random_note_2.0)

![random_note_2.0](random_note_2.0.png) 

Вариация. Меньше тонких настроек. Выводит один из трёх вариантов контента: 

- три ==подсвеченных== слова с контекстом
- случайный тег из вашего списка (вставьте в начало скрипта)
- случайную задачу

Как пользоваться: см. выше.
