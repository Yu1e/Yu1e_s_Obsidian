...
[Глоссарий](Glossary) - собирает алфавитный список ==подсвеченных== ==фрагментов== из всех заметок хранилища.
...
[random_note](random_note) Выводит случайную заметку с настройкой периодичности, веса предпочитаемых папок и тегов, с исключением папок и тегов.

Как пользоваться: создайте заметку, разместите в ней блок кода dataviewjs. Закрепите заметку в левой или правой панели, перетащив из Проводника Обсидиана. Не перетаскивайте из основного окна - иначе закрепится широкая вкладка, а не значок.
